  ...
  private HomePage homePage;
    ...
    public void successfulRegistrationTest() throws InterruptedException {
        ...
        try {
            ...
            //SeleniumUtils.screenshotAllure(driver, "Chrome_SuccessfulRegistration");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void successfulStreaming() {
        ...
        try {
            SeleniumUtils.screenshot(driver, "Chrome_SuccesFullStreaming");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void successfullSearch(){
       ...
       try {
            SeleniumUtils.screenshot(driver, "Chrome_SuccessFullSearch");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void successfullAddToWatchlist(){
        ...
        try {
            SeleniumUtils.screenshot(driver, "Chrome_SuccessFullAddToWatchList");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        String RemovedFromWatchList = moviePage.checkIfAddedOrRemovedFromWatchList();
        assertTrue(RemovedFromWatchList.contains("preplay-addToWatchlist"));

        try {
            SeleniumUtils.screenshot(driver, "Chrome_SuccessFullRemovedFromWatchList");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
/*
    ...
    @Test
    public void successfullMarkAndUnMarkedAsPlayed(){
        email = "PlexTester1@mailinator.com";
        login(email);
        ...
        String checkAddedToWatchList = moviePage.checkIfMarkedAsPlayed();
        assertTrue(checkAddedToWatchList.contains("plex-icon-toolbar-mark-unplayed-560"));

        try {
            SeleniumUtils.screenshot(driver, "Chrome_SuccessFullMarkAsPlayed");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        String checkRemovedToWatchList = moviePage.checkUnMarkedAsPlayed();
        assertTrue(checkRemovedToWatchList.contains("plex-icon-toolbar-mark-played-560"));

        try {
            SeleniumUtils.screenshot(driver, "Chrome_SuccessFullUnMarkAsPlayed");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
/*
    ...
    @Test
    public void successfullAccount(){
        email = "PlexTester1@mailinator.com";
        login(email);
